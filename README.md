...
[ Frontend: React + Browser Speech API ]
                   |
                   v (Raw Text + Speech Timing)
[ Lovable / Supabase Server Function ]
                   |
        +----------+----------+
        |                     |
[ Deterministic Math ]   [ Featherless.ai API ]
 (Brunét's Index)         (Semantic Extraction)
        |                     |
        +----------+----------+
                   |
                   v (Integers Only!)
[ Postgres Database: Zero-Text Stored ]
